<template>
	<view>
		...
		<image src="https://static.maxcang.com/appstatic/merchant/total-rank.png" mode="widthFix" class="total_bg"></image>
		<view class="content">
			<view class="btns">
				<image src="https://static.maxcang.com/appstatic/merchant/btn_1.png" mode="widthFix" class="btn_item" @click="toNew"></image>
...
import { getTotalRanking } from '../../service/merchant';
...
const toNew = ()=>{
	uni.navigateTo({
		url: '/pages/merchant/merchant_rank_new'
	})
}
const toSale = ()=>{
	uni.navigateTo({
